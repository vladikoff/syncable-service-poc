...
var HistoryService = {
  ...
  updateItems: function(historyItems) {
    return group(historyItems.map(function (historyInfo) {
      //L.log('got item', historyInfo);
      // TODO: update this?? needs to be .doc for Pouchdb
      return HistoryItem(historyInfo.doc).toPlaceInfo();
    })).
  ...
  addObserver: function(observer) {
    PlacesUtils.history.addObserver(observer, true);
  },
